...
category_delete_get: (req, res, next) => {
    ...
    (err, results) => {
        ...
        res.render('admin/categories/delete', { title: 'Delete Category', breadcrumb: 'Remove Category', category: results.category, category_posts: results.category_posts, csrf: req.csrfToken() } );
    });
},
